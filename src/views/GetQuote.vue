    ...
    <div class="img-div">
      <div class="text-section">
        <div>
          ...
          <p>
            it's simple, you can now ask for a free quote and here is how it
            works..
          </p>
        </div>
        <div>
          <ul>
            ...
            <li>
              3- After sending your request, you will recieve a tracking number
              to your email, this tracking nummber will help you track your
              command status
            </li>
            <li>
              4- Our team will review your command in the next 48 hours and will
              contact you to lock the price and with your approval, close the
              deal
            </li>
            <li>
              5- you will keep using your unique tracking number to keep
